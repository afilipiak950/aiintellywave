...
const MiraAI = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      ...
      <div className={`relative bg-gradient-to-r from-indigo-500/10 to-purple-500/10 rounded-xl overflow-hidden transition-all duration-700 ease-out border border-primary/10 shadow-lg ${isLoading ? 'opacity-0 scale-95' : 'opacity-100 scale-100'}`}>
