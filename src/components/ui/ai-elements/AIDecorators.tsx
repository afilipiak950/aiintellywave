  ...
  return (
    <div className={cn("relative overflow-hidden bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-lg p-6", className)}>
      ...
      <div className="absolute inset-0 overflow-hidden opacity-10 pointer-events-none">
        <AIThemeElements variant="sparse" className="opacity-20" />
        <AIDecorator type="circuit" className="top-5 right-5 text-blue-400 opacity-10" />
        <AIDecorator type="nodes" className="bottom-5 left-5 text-indigo-400 opacity-10" />
        <div className="absolute -left-5 -top-5 w-20 h-20 bg-blue-200 dark:bg-blue-700 rounded-full filter blur-2xl opacity-10"></div>
        <div className="absolute -right-5 -bottom-5 w-20 h-20 bg-indigo-200 dark:bg-indigo-700 rounded-full filter blur-2xl opacity-10"></div>
      </div>
