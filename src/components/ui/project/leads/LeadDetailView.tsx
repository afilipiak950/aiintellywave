        ...
        <div className="h-full">
          <div className="relative">
            ...
            <div className="relative pt-6 px-6 pb-4">
              <div className="flex justify-between items-start mb-4">
                ...
                <div className="flex space-x-2">
                  ...
                  <SheetClose className="bg-black/70 p-1.5 rounded-md text-white hover:bg-black/80 transition-colors">
                    <X className="h-5 w-5" />
                  </SheetClose>
                </div>
              </div>
            ...
            <div className="bg-gray-50 min-h-[calc(100vh-8rem)] rounded-t-3xl p-5 overflow-y-auto">
              ...
              {/* Convert button */}
              <div className="fixed bottom-0 right-0 left-0 lg:left-auto lg:max-w-xl p-4 bg-white border-t">
                <Button 
